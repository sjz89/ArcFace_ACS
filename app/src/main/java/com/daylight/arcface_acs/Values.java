...
/**
 *
 * Created by Daylight on 2018/1/24.
 */

public class Values {
    public final static String appid = "4HWArkFf3q48Trk9B5F5Gti8Cs1estFWpcdDGtraMVhu";
    ...
    public final static int FROZEN=-200;
    public final static int AVAILABLE=100;
